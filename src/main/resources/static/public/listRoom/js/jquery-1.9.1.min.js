...
function ShowMesagebox(noiDung) {
    $('#modal-announcement .modal-dialog .modal-content .modal-footer').html('<button type="button" class="btn btn-default" data-dismiss="modal">OK</button>')
    $('.modal-announcement-message').html(noiDung);
