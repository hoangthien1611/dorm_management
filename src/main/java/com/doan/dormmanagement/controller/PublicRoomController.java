...
//
//    private Integer lastMonth = localCalendar.get(Calendar.MONTH) - 1;
//    private Integer currentYear = localCalendar.get(Calendar.YEAR);
    ...
    public String getDetailRoom(Model model, @PathVariable("id") Integer id) {
        ...
        model.addAttribute("subsistence", subsistenceFeeService.getSubsistenceFeeByRoomIdWithDate(id, 11, 2018));
